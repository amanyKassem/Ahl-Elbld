...
function FastingBreakfast({navigation,route}) {
    ...
    function Item({ name , image , location , id , index }) {
        return (
            <TouchableOpacity onPress={() => navigation.navigate('fastingBreakfastDetails')} style={[styles.borderGray,styles.marginBottom_20 , styles.directionRow , styles.Radius_5 , {flex:1 , padding:10}]}>
...
export default FastingBreakfast;
