...
function SpecialOrders({navigation,route}) {
    ...
    const myOrders =[
        {id :'0',name:'مطاعم'  , date:'9/7/2019' , orderNum:'12345', image:require("../../assets/images/banner1.png")},
        {id :'1',name:'محلات'  , date:'9/7/2019' , orderNum:'12345', image:require("../../assets/images/banner2.png")},
        {id :'2',name:'مخابز'  , date:'9/7/2019' , orderNum:'12345', image:require("../../assets/images/banner3.png")},
        {id :'3',name:'حلويات'  , date:'9/7/2019' , orderNum:'12345', image:require("../../assets/images/banner4.png")},
    ]
