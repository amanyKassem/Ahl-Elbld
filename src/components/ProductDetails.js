                ...
                <View style={[styles.bgFullWidth ,styles.bg_White, styles.Width_100,styles.paddingHorizontal_20 , styles.marginTop_10, {overflow:'hidden'}]}>
...

                    {
                        pathName === 'categoryDetails' ?
                            <View>
                                <TouchableOpacity onPress={() => navigation.navigate('basketDetails')} style={[styles.mstrdaBtn , styles.Width_90 , styles.bg_gray , styles.SelfCenter  , styles.marginBottom_10]}>
                                    <Text style={[styles.textBold , styles.text_White , styles.textSize_14]}>{ i18n.t('orderNow') }</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => navigation.navigate('orderData')} style={[styles.mstrdaBtn , styles.Width_90 , styles.SelfCenter  , styles.marginBottom_20]}>
